...
<!-- BEGIN AI-INLINE:1b6a886f0f16 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 1</span>
<h3>Generative dan Agentic AI untuk Pendahuluan Machine Learning dan Problem Framing</h3>

**Arah RPS.** Supervised, unsupervised, ensemble, deep learning, representation learning, dan pengantar generative AI sesuai relevansi masalah statistika terapan.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan Machine Learning; Definisi, ruang lingkup, dan aplikasi machine learning di berbagai bidang; Perbedaan machine learning dengan statistik klasik. |
...
<!-- BEGIN AI-INLINE:50e7faa403e1 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Algoritma Kerja Praktikum</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Pendahuluan Machine Learning dan Problem Framing.</p>
...
<!-- BEGIN AI-INLINE:5f683314c361 -->
<div class="ai-inline ai-inline--assessment">
<span class="ai-inline__label">Aturan AI untuk latihan dan asesmen</span>
<h4>Penerapan pada Mini Tugas</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Pendahuluan Machine Learning dan Problem Framing.</p>
<p>Ikuti status asesmen yang ditetapkan dosen: tanpa AI, AI terbatas, atau AI terbuka. Jika diizinkan, AI hanya memberi kritik, pertanyaan tandingan, atau pemeriksaan awal; jawaban, keputusan metode, dan pembelaan lisan tetap karya mahasiswa. Bukti yang diserahkan: prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:9dc02fdcc0be -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 2</span>
<h3>Generative dan Agentic AI untuk Analisis Kebutuhan dan Karakteristik Data</h3>

**Arah RPS.** Uncertainty-aware machine learning, calibration, domain shift, causal ML, explainability, fairness, privacy-preserving learning, dan robustness.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Analisis Kebutuhan dan Karakteristik Data; Identifikasi tipe data (numerik, kategorik, time series, dsb). |
...
<!-- BEGIN AI-INLINE:42daf8fc222c -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Analisis Kebutuhan dan Karakteristik Data.</p>
<p>Minta AI menjelaskan **Analisis Kebutuhan dan Karakteristik Data** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:6536a4a0048b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 3</span>
<h3>Generative dan Agentic AI untuk Pemilihan Metode Berdasarkan Karakteristik Data</h3>

**Arah RPS.** MLOps, versioning, experiment tracking, monitoring, reproducibility, model card, dan audit model.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pemilihan metode ML berdasarkan karakteristik dan tujuan data; Supervised Learning – Regresi; Regresi linier dan polynomial. |
...
<!-- BEGIN AI-INLINE:ce9a7087ca4f -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Pemilihan Metode Berdasarkan Karakteristik Data.</p>
<p>Minta AI menjelaskan **Pemilihan Metode Berdasarkan Karakteristik Data** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:63841b48c480 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 4</span>
<h3>Generative dan Agentic AI untuk Supervised Learning untuk Regresi</h3>

**Arah RPS.** Capstone berbasis data nyata atau mitra lintas sektor dengan pembanding statistika, external validation, analisis dampak, dan komunikasi kepada stakeholder.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Ridge, Lasso, dan Elastic Net Regression; Gradient Descent & Optimasi; Supervised Learning – Klasifikasi. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:21d189ec6798 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Supervised Learning untuk Regresi.</p>
<p>Minta AI menjelaskan **Supervised Learning untuk Regresi** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:e020f0c62c62 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 5</span>
<h3>Generative dan Agentic AI untuk Supervised Learning untuk Klasifikasi</h3>

**Arah RPS.** Supervised, unsupervised, ensemble, deep learning, representation learning, dan pengantar generative AI sesuai relevansi masalah statistika terapan.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Logistic Regression; Decision Tree & Random Forest. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:022b6aaa13ee -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 5: Supervised Learning untuk Klasifikasi.</p>
<p>Minta AI menjelaskan **Supervised Learning untuk Klasifikasi** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:09dc0c4c6c6e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 6</span>
<h3>Generative dan Agentic AI untuk Unsupervised Learning: Clustering dan Reduksi Dimensi</h3>

**Arah RPS.** Uncertainty-aware machine learning, calibration, domain shift, causal ML, explainability, fairness, privacy-preserving learning, dan robustness.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Support Vector Machine (SVM); K-Nearest Neighbors (KNN); Naive Bayes. |
...
<!-- BEGIN AI-INLINE:68e360dc4bbb -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 6: Unsupervised Learning: Clustering dan Reduksi Dimensi.</p>
<p>Minta AI menjelaskan **Unsupervised Learning: Clustering dan Reduksi Dimensi** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:6d8d6a417b9b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 7</span>
<h3>Generative dan Agentic AI untuk Feature Engineering, Feature Selection, dan Pipeline Awal</h3>

**Arah RPS.** MLOps, versioning, experiment tracking, monitoring, reproducibility, model card, dan audit model.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Unsupervised Learning; Clustering: K-Means, Hierarchical, Fuzzy C-Means (FCM), K-Medoid. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:b077a64cb75d -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 7: Feature Engineering, Feature Selection, dan Pipeline Awal.</p>
<p>Minta AI menjelaskan **Feature Engineering, Feature Selection, dan Pipeline Awal** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:61f7b7e9c51a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 8</span>
<h3>Generative dan Agentic AI untuk UTS Berbasis Proyek: Audit, Baseline, dan Pipeline Sementara</h3>
...
<!-- BEGIN AI-INLINE:7f212fd60da9 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 8: UTS Berbasis Proyek: Audit, Baseline, dan Pipeline Sementara.</p>
<p>Minta AI menjelaskan **UTS Berbasis Proyek: Audit, Baseline, dan Pipeline Sementara** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:bd69a027bfe9 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 9</span>
<h3>Generative dan Agentic AI untuk Ensemble Learning dan Gradient Boosting</h3>

**Arah RPS.** Capstone berbasis data nyata atau mitra lintas sektor dengan pembanding statistika, external validation, analisis dampak, dan komunikasi kepada stakeholder.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Dimensional Reduction: Principal Component Analysis (PCA), Analisis Faktor, t-SNE; Neural Network & Deep Learning; Dasar-dasar Neural Network. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:87b0854bd5bf -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 9: Ensemble Learning dan Gradient Boosting.</p>
<p>Minta AI menjelaskan **Ensemble Learning dan Gradient Boosting** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:706971b621b2 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 10</span>
<h3>Generative dan Agentic AI untuk Neural Network dan Deep Learning</h3>

**Arah RPS.** Supervised, unsupervised, ensemble, deep learning, representation learning, dan pengantar generative AI sesuai relevansi masalah statistika terapan.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Pengenalan Deep Learning; Gradient Boosting dan Ensemble Learning; Konsep Ensemble Learning (Bagging, Boosting). |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:2771347211ef -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 10: Neural Network dan Deep Learning.</p>
<p>Minta AI menjelaskan **Neural Network dan Deep Learning** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:d324b27efdd7 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 11</span>
<h3>Generative dan Agentic AI untuk Model Evaluation, Validation, dan Model Comparison</h3>

**Arah RPS.** Uncertainty-aware machine learning, calibration, domain shift, causal ML, explainability, fairness, privacy-preserving learning, dan robustness.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Gradient Boosting untuk regresi dan time series; Feature Engineering & Selection. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:b6a2e3789db6 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 11: Model Evaluation, Validation, dan Model Comparison.</p>
<p>Minta AI menjelaskan **Model Evaluation, Validation, dan Model Comparison** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:5cd71c4eb8a0 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 12</span>
<h3>Generative dan Agentic AI untuk Hyperparameter Tuning dan Eksperimen Reproducible</h3>

**Arah RPS.** MLOps, versioning, experiment tracking, monitoring, reproducibility, model card, dan audit model.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Teknik ekstraksi, seleksi, dan transformasi fitur; Model Evaluation & Validation; K-Fold Cross Validation, Hold-Out, Confusion Matrix. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:12c024a1c20f -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 12: Hyperparameter Tuning dan Eksperimen Reproducible.</p>
<p>Minta AI menjelaskan **Hyperparameter Tuning dan Eksperimen Reproducible** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:5ff52c52aa4d -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 13</span>
<h3>Generative dan Agentic AI untuk Interpretasi Model dan Explainable Machine Learning</h3>

**Arah RPS.** Capstone berbasis data nyata atau mitra lintas sektor dengan pembanding statistika, external validation, analisis dampak, dan komunikasi kepada stakeholder.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Metrik evaluasi untuk regresi dan klasifikasi (MSE, RMSE, Accuracy, Precision, Recall, F1 Score, ROC-AUC); Hyperparameter Tuning; Grid Search, Random Search, dan teknik tuning lain. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:a0b7b082f9c9 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 13: Interpretasi Model dan Explainable Machine Learning.</p>
<p>Minta AI menjelaskan **Interpretasi Model dan Explainable Machine Learning** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:20b4443ca552 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 14</span>
<h3>Generative dan Agentic AI untuk Visualisasi dan Komunikasi Hasil Analisis</h3>

**Arah RPS.** Supervised, unsupervised, ensemble, deep learning, representation learning, dan pengantar generative AI sesuai relevansi masalah statistika terapan.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: End-to-End Pipeline Machine Learning; Integrasi proses preprocessing, pemodelan, evaluasi, interpretasi, dan deployment. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:3b390fa629ff -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 14: Visualisasi dan Komunikasi Hasil Analisis.</p>
<p>Minta AI menjelaskan **Visualisasi dan Komunikasi Hasil Analisis** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:5d2e5e136e8f -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 15</span>
<h3>Generative dan Agentic AI untuk Pelaporan Ilmiah, Peer Review, dan Revisi Proyek</h3>

**Arah RPS.** Uncertainty-aware machine learning, calibration, domain shift, causal ML, explainability, fairness, privacy-preserving learning, dan robustness.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Interpretasi & Komunikasi Hasil Analisis; Visualisasi hasil model; Pelaporan ilmiah dan presentasi hasil machine learning. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:a5bcfe1e9991 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 15: Pelaporan Ilmiah, Peer Review, dan Revisi Proyek.</p>
<p>Minta AI menjelaskan **Pelaporan Ilmiah, Peer Review, dan Revisi Proyek** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0cd48de00383 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 16</span>
<h3>Generative dan Agentic AI untuk UAS Proyek Akhir dan Pertahanan Hasil Analisis</h3>
...
<!-- BEGIN AI-INLINE:c9ddb119c3a9 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Narasi Konseptual dan Landasan Teoretis</h4>
<p><strong>Konteks:</strong> Pertemuan 16: UAS Proyek Akhir dan Pertahanan Hasil Analisis.</p>
<p>Minta AI menjelaskan **UAS Proyek Akhir dan Pertahanan Hasil Analisis** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:aa294e80d82a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Rubrik Penilaian Terintegrasi</h3>
...
<!-- BEGIN AI-INLINE:bca611cf9492 -->
<div class="ai-inline ai-inline--assessment">
<span class="ai-inline__label">Aturan AI untuk latihan dan asesmen</span>
<h4>Penerapan pada Diskusi</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Template Laporan Proyek Akhir.</p>
<p>Ikuti status asesmen yang ditetapkan dosen: tanpa AI, AI terbatas, atau AI terbuka. Jika diizinkan, AI hanya memberi kritik, pertanyaan tandingan, atau pemeriksaan awal; jawaban, keputusan metode, dan pembelaan lisan tetap karya mahasiswa. Bukti yang diserahkan: prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ea2434f724ac -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 4</span>
<h3>Generative dan Agentic AI untuk Bank Latihan Mandiri Tambahan</h3>
...
Materi **Pembelajaran Mesin** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- Supervised, unsupervised, ensemble, deep learning, representation learning, dan pengantar generative AI sesuai relevansi masalah statistika terapan.
- Uncertainty-aware machine learning, calibration, domain shift, causal ML, explainability, fairness, privacy-preserving learning, dan robustness.
- MLOps, versioning, experiment tracking, monitoring, reproducibility, model card, dan audit model.
...
<!-- BEGIN AI-INLINE:de7829d502d6 -->
<div class="ai-inline ai-inline--assessment">
<span class="ai-inline__label">Aturan AI untuk latihan dan asesmen</span>
<h4>Penerapan pada Bukti asesmen</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Bank Latihan Mandiri Tambahan.</p>
<p>Ikuti status asesmen yang ditetapkan dosen: tanpa AI, AI terbatas, atau AI terbuka. Jika diizinkan, AI hanya memberi kritik, pertanyaan tandingan, atau pemeriksaan awal; jawaban, keputusan metode, dan pembelaan lisan tetap karya mahasiswa. Bukti yang diserahkan: prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
