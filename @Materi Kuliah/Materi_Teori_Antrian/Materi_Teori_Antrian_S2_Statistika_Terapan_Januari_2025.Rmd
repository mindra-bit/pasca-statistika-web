...
<!-- BEGIN AI-INLINE:5ac43468cc9b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Landasan Teori dan Cara Berpikir Sistem</h3>

**Arah RPS.** Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan dan Konsep Dasar Teori Antrian; Definisi, sejarah, dan ruang lingkup teori antrian. |
...
<!-- BEGIN AI-INLINE:c99d7abd1ed0 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Alur analisis umum</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
...
<!-- BEGIN AI-INLINE:a5dc0dd5351b -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus dan interpretasi inti</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Landasan Teori dan Cara Berpikir Sistem**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:a4d353aee745 -->
<div class="ai-inline ai-inline--assessment">
<span class="ai-inline__label">Aturan AI untuk latihan dan asesmen</span>
<h4>Penerapan pada Catatan pendalaman untuk diskusi kelas</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Ikuti status asesmen yang ditetapkan dosen: tanpa AI, AI terbatas, atau AI terbuka. Jika diizinkan, AI hanya memberi kritik, pertanyaan tandingan, atau pemeriksaan awal; jawaban, keputusan metode, dan pembelaan lisan tetap karya mahasiswa. Bukti yang diserahkan: prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:182db7f29053 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Pertemuan 8: UTS: Proyek Pendahuluan Pemodelan Data Nyata</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ec0ab555571a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Pertemuan 11: Implementasi Simulasi dengan R dan Python</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Agen dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap. Tetapkan checkpoint sebelum perubahan data, pemilihan model, dan penerbitan hasil. **Mahasiswa wajib memeriksa:** ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif. Simpan prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:8cc589470df6 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Pertemuan 16: UAS: Penulisan Ilmiah dan Presentasi Hasil Analisis</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:960c73d7aa3c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.1: Rumah sakit rawat jalan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:9bb7e94ca17e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.2: Call center layanan publik</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:5dd3d45f028b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.3: Gerbang tol</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:83ad7f5f5c96 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.4: Administrasi akademik</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:114adb9a2d41 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.5: Manufaktur</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:f55856d7c964 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.6: Restoran cepat saji</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0e6a3056519c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.7: Bandara</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:2fc8f3aa0d43 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Studi Kasus F.8: Platform digital</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:757b9e2bbfe7 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Catatan pengayaan 7: platform komputasi awan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Landasan Teori dan Cara Berpikir Sistem.</p>
<p>Agen dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap. Tetapkan checkpoint sebelum perubahan data, pemilihan model, dan penerbitan hasil. **Mahasiswa wajib memeriksa:** ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif. Simpan prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
Materi **Teori Antrian** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- Simulasi discrete-event, digital twin, estimasi parameter berbasis data, dan optimasi kebijakan layanan.
- Pengenalan reinforcement learning atau learning-based control untuk sistem antrian, disertai pembanding kebijakan analitik.
- Studi kasus layanan kesehatan, transportasi, atau industri dengan analisis sensitivitas, biaya, fairness layanan, dan robustness.
