...
<!-- BEGIN AI-INLINE:55dd6d32c92f -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Konsep Dasar Sampling Survey dan Inferensi Berbasis Desain</h3>

**Arah RPS.** Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan Sampling Survey; Tujuan pembelajaran dan kontrak perkuliahan; Konsep populasi, sampel, dan parameter. |
...
<!-- BEGIN AI-INLINE:5c0ec0c0255c -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Konsep Dasar Sampling Survey dan Inferensi Berbasis Desain.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Konsep Dasar Sampling Survey dan Inferensi Berbasis Desain**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0466766526ac -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 2</span>
<h3>Generative dan Agentic AI untuk Distribusi Sampling, Standard Error, dan Presisi Estimator</h3>

**Arah RPS.** Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Peran sampling dalam penelitian; Distribusi Sampling; Konsep distribusi sampling dan estimasi parameter; Standar error dan prinsip inferensi. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:1b98f7bbeb37 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Distribusi Sampling, Standard Error, dan Presisi Estimator.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Distribusi Sampling, Standard Error, dan Presisi Estimator**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:74ecda4098ee -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 3</span>
<h3>Generative dan Agentic AI untuk Simple Random Sampling: SRSWOR dan SRSWR</h3>

**Arah RPS.** Proyek survei nyata yang membandingkan pendekatan design-based, model-assisted/model-based, dan AI, disertai estimasi ketidakpastian, dokumentasi reproducible, dan komunikasi kepada pengguna.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Sampling Acak Sederhana (Simple Random Sampling - SRS); Desain dan implementasi SRS; Estimasi rata-rata, total, dan proporsi. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:bf7c0c647b97 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Simple Random Sampling: SRSWOR dan SRSWR.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Simple Random Sampling: SRSWOR dan SRSWR**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:dc19e1c3213c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 4</span>
<h3>Generative dan Agentic AI untuk Sampling Sistematis: Interval, Random Start, dan Risiko Periodisitas</h3>

**Arah RPS.** Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Sampling Sistematis; Prosedur pengambilan sampel sistematis; Estimasi dan perbandingan dengan SRS. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:9dee927087b2 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Sampling Sistematis: Interval, Random Start, dan Risiko Periodisitas.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Sampling Sistematis: Interval, Random Start, dan Risiko Periodisitas**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b8ed3583786d -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 5</span>
<h3>Generative dan Agentic AI untuk Sampling Stratifikasi: Alokasi Proporsional, Neyman, dan Optimal</h3>

**Arah RPS.** Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Sampling Stratifikasi (Stratified Sampling); Alasan stratifikasi; Alokasi proporsional dan optimal; Estimasi dan efisiensi. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:4005246e7e3f -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 5: Sampling Stratifikasi: Alokasi Proporsional, Neyman, dan Optimal.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Sampling Stratifikasi: Alokasi Proporsional, Neyman, dan Optimal**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b1a33583ed8b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 6</span>
<h3>Generative dan Agentic AI untuk Sampling Klaster: Desain Satu Tahap, Dua Tahap, dan Design Effect</h3>

**Arah RPS.** Proyek survei nyata yang membandingkan pendekatan design-based, model-assisted/model-based, dan AI, disertai estimasi ketidakpastian, dokumentasi reproducible, dan komunikasi kepada pengguna.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Sampling Klaster (Cluster Sampling); Desain satu tahap dan dua tahap; Estimasi rata-rata dan total. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:119c69e0e8fe -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 6: Sampling Klaster: Desain Satu Tahap, Dua Tahap, dan Design Effect.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Sampling Klaster: Desain Satu Tahap, Dua Tahap, dan Design Effect**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:d12bede3c259 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 7</span>
<h3>Generative dan Agentic AI untuk Multistage Sampling dan Desain Survei Kompleks</h3>

**Arah RPS.** Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Efisiensi relatif terhadap SRS; Multistage Sampling dan Complex Sampling Design; Desain bertingkat; Pertimbangan desain dalam survei besar. |
...
<!-- BEGIN AI-INLINE:91863d5a0247 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 7: Multistage Sampling dan Desain Survei Kompleks.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Multistage Sampling dan Desain Survei Kompleks**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:3008d4e050f6 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 8</span>
<h3>Generative dan Agentic AI untuk Penaksir Rasio, Difference, dan Regresi</h3>
...
<!-- BEGIN AI-INLINE:8994b90b6fe0 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 8: Penaksir Rasio, Difference, dan Regresi.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Penaksir Rasio, Difference, dan Regresi**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:d79c24eda9ce -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 9</span>
<h3>Generative dan Agentic AI untuk Analisis Data Complex Survey dengan R</h3>

**Arah RPS.** Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Kombinasi teknik sampling; Penaksir Rasio, Difference, dan Regresi; Rasio estimator dan regresi estimator. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:779e6c05d9c4 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 9: Analisis Data Complex Survey dengan R.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Analisis Data Complex Survey dengan R**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ce1104225078 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 10</span>
<h3>Generative dan Agentic AI untuk Penanganan Non-response dan Missing Data dalam Survei</h3>

**Arah RPS.** Proyek survei nyata yang membandingkan pendekatan design-based, model-assisted/model-based, dan AI, disertai estimasi ketidakpastian, dokumentasi reproducible, dan komunikasi kepada pengguna.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Efisiensi dan bias; Aplikasi pada data nyata; Analisis Data dari Complex Survey. |
...
<!-- BEGIN AI-INLINE:147e2dba3f65 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 10: Penanganan Non-response dan Missing Data dalam Survei.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Penanganan Non-response dan Missing Data dalam Survei**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:9ed853399396 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 11</span>
<h3>Generative dan Agentic AI untuk Double Sampling atau Two-Phase Sampling</h3>

**Arah RPS.** Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Penanganan weight, strata, dan PSU; Penggunaan perangkat lunak statistika (misalnya R: survey package); Penanganan Non-Response; Tipe non-response. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:88e92431f625 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 11: Double Sampling atau Two-Phase Sampling.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Double Sampling atau Two-Phase Sampling**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:18f03293a127 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 12</span>
<h3>Generative dan Agentic AI untuk Sampling Error, Nonsampling Error, dan Total Survey Error</h3>

**Arah RPS.** Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Metode imputasi dan penyesuaian bobot; Double Sampling; Konsep dan penerapan. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:9b5fde5e8c1a -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 12: Sampling Error, Nonsampling Error, dan Total Survey Error.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Sampling Error, Nonsampling Error, dan Total Survey Error**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:cdf4b1f6a206 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 13</span>
<h3>Generative dan Agentic AI untuk PPS Systematic Sampling dan Adaptive Sampling</h3>

**Arah RPS.** Proyek survei nyata yang membandingkan pendekatan design-based, model-assisted/model-based, dan AI, disertai estimasi ketidakpastian, dokumentasi reproducible, dan komunikasi kepada pengguna.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Estimasi dalam two-phase sampling; Kesalahan dalam Sampling; Sampling error dan nonsampling error. |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:e9c27ac4d8ce -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 13: PPS Systematic Sampling dan Adaptive Sampling.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **PPS Systematic Sampling dan Adaptive Sampling**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:f03f21ca6807 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 14</span>
<h3>Generative dan Agentic AI untuk Non-Probability Sampling dan Batas Inferensi</h3>

**Arah RPS.** Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Evaluasi kualitas survei; Teknik Sampling Lainnya; Systematic PPS sampling; Adaptive sampling (jika relevan). |
| Generative AI | Digunakan untuk mengurai notasi dan menawarkan langkah derivasi alternatif tanpa menggantikan pembuktian mahasiswa. |
| Agentic AI | Dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:49a6d51fd2c5 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 14: Non-Probability Sampling dan Batas Inferensi.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Non-Probability Sampling dan Batas Inferensi**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:88efb399abe8 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 15</span>
<h3>Generative dan Agentic AI untuk Integrasi Proyek Akhir: Desain, Implementasi, Evaluasi, dan Inovasi</h3>

**Arah RPS.** Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Non-Probability Sampling; Purposive, quota, dan snowball sampling; Keterbatasan inferensi. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:7c66824223ff -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Rumus inti dan penafsiran</h4>
<p><strong>Konteks:</strong> Pertemuan 15: Integrasi Proyek Akhir: Desain, Implementasi, Evaluasi, dan Inovasi.</p>
<p>Gunakan AI untuk mengurai notasi dan menawarkan alternatif derivasi pada **Integrasi Proyek Akhir: Desain, Implementasi, Evaluasi, dan Inovasi**, lalu periksa setiap langkah secara manual, uji kasus batas, dan cocokkan dengan rujukan primer. AI tidak boleh menjadi satu-satunya sumber rumus atau pembuktian; kesetaraan simbolik wajib dibuktikan mahasiswa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:225f42a31eec -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 17</span>
<h3>Generative dan Agentic AI untuk Studi Kasus Terpadu: Merancang Survei Literasi Digital Rumah Tangga</h3>
...
<!-- BEGIN AI-INLINE:213598dd2525 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Analisis dan pelaporan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Studi Kasus Terpadu: Merancang Survei Literasi Digital Rumah Tangga.</p>
...
<!-- BEGIN AI-INLINE:3bb00f0509f3 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 18</span>
<h3>Generative dan Agentic AI untuk Studi Kasus Terpadu: Survei Kesehatan dengan Oversampling Kelompok Risiko</h3>
...
<!-- BEGIN AI-INLINE:468c5f56e649 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 19</span>
<h3>Generative dan Agentic AI untuk Studi Kasus Terpadu: Audit Mutu Data Administratif dengan Sampling</h3>
...
<!-- BEGIN AI-INLINE:4e167bfd8908 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 20</span>
<h3>Generative dan Agentic AI untuk Template Laporan Proyek Sampling Survey</h3>
...
<!-- BEGIN AI-INLINE:a6abb68ba4a3 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Struktur laporan yang disarankan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Template Laporan Proyek Sampling Survey.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:80477cccfb61 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 21</span>
<h3>Generative dan Agentic AI untuk Panduan Praktikum R: Dari Simulasi sampai `survey` Package</h3>
...
<!-- BEGIN AI-INLINE:2de094b8ffbd -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 22</span>
<h3>Generative dan Agentic AI untuk Glosarium Sampling Survey</h3>
...
<!-- BEGIN AI-INLINE:468594a0057e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 23</span>
<h3>Generative dan Agentic AI untuk Bank Soal Reflektif dan Latihan</h3>
...
<!-- BEGIN AI-INLINE:abf9597c0869 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 24</span>
<h3>Generative dan Agentic AI untuk Checklist Kualitas Sebelum Survei Dilaksanakan</h3>
...
<!-- BEGIN AI-INLINE:d9a3b4cb7f92 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 25</span>
<h3>Generative dan Agentic AI untuk Penutup</h3>
...
<!-- BEGIN AI-INLINE:00a33760abab -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan pengayaan 5: estimasi domain dan pelaporan kebijakan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Penutup.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:1bfb484550be -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan pengayaan 21: estimasi domain dan pelaporan kebijakan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Penutup.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:7b8f6f2f0d5d -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan pengayaan 37: estimasi domain dan pelaporan kebijakan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Penutup.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:74e9f4f6432b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan pengayaan 53: estimasi domain dan pelaporan kebijakan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Penutup.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0cf089029074 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan pengayaan 69: estimasi domain dan pelaporan kebijakan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Penutup.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
Materi **Sampling Survey** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- Machine learning untuk nonresponse adjustment, propensity modeling, imputation, prediksi berbasis auxiliary data, dan adaptive survey design sebagai pengayaan metode survei.
- Pemanfaatan paradata, data linkage, web/sensor data, dan integrasi sumber data dengan evaluasi coverage error, measurement error, privasi, fairness, dan kualitas data.
- Proyek survei nyata yang membandingkan pendekatan design-based, model-assisted/model-based, dan AI, disertai estimasi ketidakpastian, dokumentasi reproducible, dan komunikasi kepada pengguna.
