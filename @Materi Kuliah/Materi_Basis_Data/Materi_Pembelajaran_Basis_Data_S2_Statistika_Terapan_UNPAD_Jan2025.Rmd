...
<!-- BEGIN AI-INLINE:d12bb927a2c8 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 1</span>
<h3>Generative dan Agentic AI untuk Pendahuluan Sistem Basis Data untuk Riset Statistik</h3>

**Arah RPS.** Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan Sistem Basis Data dan Data Warehouse; Peran Basis Data dalam riset statistik multidisiplin; Arsitektur sistem Basis Data vs data warehouse. |
...
<!-- BEGIN AI-INLINE:401cc155daff -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 2</span>
<h3>Generative dan Agentic AI untuk Analisis Kebutuhan Data dan Pemodelan Konseptual</h3>

**Arah RPS.** Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Studi kasus integrasi data; Model Data Relasional dan Perancangan ER-Diagram; Konsep model data relasional tingkat lanjut. |
...
<!-- BEGIN AI-INLINE:f4b843ae25c4 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Analisis Kebutuhan Data dan Pemodelan Konseptual.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b976ef99644c -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Analisis Kebutuhan Data dan Pemodelan Konseptual.</p>
<p>Minta AI menjelaskan **Analisis Kebutuhan Data dan Pemodelan Konseptual** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:4119b935e30e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 3</span>
<h3>Generative dan Agentic AI untuk Model Data Relasional, ERD Lanjutan, dan Normalisasi</h3>

**Arah RPS.** Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Perancangan Entity-Relationship Diagram (ERD) untuk kebutuhan riset; Studi desain basis data multidisiplin; Sistem Manajemen Basis Data Lanjutan. |
...
<!-- BEGIN AI-INLINE:0a7f2f869511 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Model Data Relasional, ERD Lanjutan, dan Normalisasi.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:d23c9a225d96 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Model Data Relasional, ERD Lanjutan, dan Normalisasi.</p>
<p>Minta AI menjelaskan **Model Data Relasional, ERD Lanjutan, dan Normalisasi** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:9ffdf5c9c264 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 4</span>
<h3>Generative dan Agentic AI untuk Arsitektur Basis Data dan Data Warehouse</h3>

**Arah RPS.** Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Struktur dan organisasi Basis Data; Keamanan, integritas, dan interoperabilitas data. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:9901d231c90e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Arsitektur Basis Data dan Data Warehouse.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:30694f5bc551 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Arsitektur Basis Data dan Data Warehouse.</p>
<p>Minta AI menjelaskan **Arsitektur Basis Data dan Data Warehouse** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:cf8fefd30069 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 5</span>
<h3>Generative dan Agentic AI untuk Aljabar Relasional dan Dasar Query Kompleks</h3>

**Arah RPS.** Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Optimasi struktur Basis Data untuk analisis statistik; Aljabar dan Kalkulus Relasional; Teori aljabar relasional untuk query. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:62a7883dda88 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 5: Aljabar Relasional dan Dasar Query Kompleks.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:bb20d7db6732 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 5: Aljabar Relasional dan Dasar Query Kompleks.</p>
<p>Minta AI menjelaskan **Aljabar Relasional dan Dasar Query Kompleks** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:df7ad445d7ff -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 6</span>
<h3>Generative dan Agentic AI untuk SQL/MySQL Lanjutan: Join, Subquery, Agregasi, View, dan Trigger</h3>

**Arah RPS.** Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Kalkulus relasional dan aplikasinya; Penyusunan query kompleks berbasis logika; Structured Query Language (SQL) dan MySQL Lanjutan. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:1563f987b033 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 6: SQL/MySQL Lanjutan: Join, Subquery, Agregasi, View, dan Trigger.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:1c787d6ff3ae -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 6: SQL/MySQL Lanjutan: Join, Subquery, Agregasi, View, dan Trigger.</p>
<p>Minta AI menjelaskan **SQL/MySQL Lanjutan: Join, Subquery, Agregasi, View, dan Trigger** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ba7fa920034d -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 7</span>
<h3>Generative dan Agentic AI untuk Optimasi Query dan Indeks untuk Data Berskala Besar</h3>

**Arah RPS.** Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Penerapan query tingkat lanjut (join, subquery, agregasi, trigger); Optimasi query untuk data berskala besar; Praktikum SQL/MySQL dengan XAMPP. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:24df39d00a0a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 7: Optimasi Query dan Indeks untuk Data Berskala Besar.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:4a4caf2159e1 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 8</span>
<h3>Generative dan Agentic AI untuk UTS: Proyek Pendahuluan, Presentasi, dan Review Desain</h3>
...
<!-- BEGIN AI-INLINE:9949d7a03031 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 8: UTS: Proyek Pendahuluan, Presentasi, dan Review Desain.</p>
...
<!-- BEGIN AI-INLINE:7f2503b4353a -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 8: UTS: Proyek Pendahuluan, Presentasi, dan Review Desain.</p>
<p>Minta AI menjelaskan **UTS: Proyek Pendahuluan, Presentasi, dan Review Desain** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:615dc4dbe19f -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 9</span>
<h3>Generative dan Agentic AI untuk Manipulasi, Manajemen, dan Integrasi Data Multi-Sumber</h3>

**Arah RPS.** Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Manipulasi, Manajemen, dan Integrasi Data; Data wrangling dan pembersihan data (cleaning); Integrasi data multi-sumber. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:9d6eac609c3b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 9: Manipulasi, Manajemen, dan Integrasi Data Multi-Sumber.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:55227a276f50 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 9: Manipulasi, Manajemen, dan Integrasi Data Multi-Sumber.</p>
<p>Minta AI menjelaskan **Manipulasi, Manajemen, dan Integrasi Data Multi-Sumber** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:7b63a4e97226 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 10</span>
<h3>Generative dan Agentic AI untuk ETL: Extract, Transform, Load dan Automasi Basis Data</h3>

**Arah RPS.** Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Workflow manajemen data statistik; ETL (Extract, Transform, Load) dan Otomasi Basis Data; Proses ETL dalam pengelolaan data statistik. |
| Generative AI | Digunakan untuk menyusun data dictionary, mendeteksi potensi masalah kualitas data, dan mengusulkan aturan pemeriksaan. |
| Agentic AI | Dapat memprofilkan data, menjalankan validasi skema, menandai missing value/outlier/duplikasi, lalu berhenti sebelum perubahan data; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa asal-usul data, unit observasi, coverage, kebocoran data, privasi, dan keputusan pembersihan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:2887e1c13022 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 10: ETL: Extract, Transform, Load dan Automasi Basis Data.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:76fc1efd7fa7 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 10: ETL: Extract, Transform, Load dan Automasi Basis Data.</p>
<p>Minta AI menjelaskan **ETL: Extract, Transform, Load dan Automasi Basis Data** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:4a7b55cb8951 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 11</span>
<h3>Generative dan Agentic AI untuk Integrasi Basis Data dengan R/Python untuk Analisis Statistik</h3>

**Arah RPS.** Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Scripting otomasi (menggunakan SQL, Python, atau R); Monitoring dan scheduling proses ETL; Agregasi Data dan Pelaporan Statistik. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:fdd0eeba123a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 11: Integrasi Basis Data dengan R/Python untuk Analisis Statistik.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:7da748369594 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 12</span>
<h3>Generative dan Agentic AI untuk Aplikasi Web Basis Data untuk Reporting Statistik</h3>

**Arah RPS.** Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Penerapan agregat data dalam laporan statistik; Statistik deskriptif berbasis basis data. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:d85e88ebf478 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 12: Aplikasi Web Basis Data untuk Reporting Statistik.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0a25615bc37b -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 12: Aplikasi Web Basis Data untuk Reporting Statistik.</p>
<p>Minta AI menjelaskan **Aplikasi Web Basis Data untuk Reporting Statistik** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:1976157b1323 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 13</span>
<h3>Generative dan Agentic AI untuk Evaluasi Kualitas Data dan Audit Basis Data Statistik</h3>

**Arah RPS.** Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Penyusunan laporan otomatis dan dashboard sederhana; Pengembangan Aplikasi Basis Data Berbasis Web; Dasar-dasar basis data web (PHP-MySQL, API, XAMPP). |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:035b04dbd1a8 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 13: Evaluasi Kualitas Data dan Audit Basis Data Statistik.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:4360961ed5e5 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 13: Evaluasi Kualitas Data dan Audit Basis Data Statistik.</p>
<p>Minta AI menjelaskan **Evaluasi Kualitas Data dan Audit Basis Data Statistik** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ef7f91f1ae57 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 14</span>
<h3>Generative dan Agentic AI untuk Keamanan, Privasi, dan Tata Kelola Akses Basis Data</h3>

**Arah RPS.** Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Pembuatan aplikasi web sederhana untuk analisis statistik; Visualisasi data dan pelaporan interaktif berbasis web; Evaluasi, Audit, dan Inovasi Basis Data untuk Riset. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:2a0e91a9d4b9 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 14: Keamanan, Privasi, dan Tata Kelola Akses Basis Data.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ba5561efe8f1 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 14: Keamanan, Privasi, dan Tata Kelola Akses Basis Data.</p>
<p>Minta AI menjelaskan **Keamanan, Privasi, dan Tata Kelola Akses Basis Data** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:369afed31db1 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 15</span>
<h3>Generative dan Agentic AI untuk Interoperabilitas, Open Data Riset, dan Inovasi Aplikasi Basis Data</h3>

**Arah RPS.** Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Audit kualitas dan keamanan Basis Data; Best practice interoperabilitas dan open data riset; Pengembangan proposal inovasi aplikasi Basis Data untuk kolaborasi riset. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:58ed3e8eb453 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 15: Interoperabilitas, Open Data Riset, dan Inovasi Aplikasi Basis Data.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:46e00707cbb1 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 15: Interoperabilitas, Open Data Riset, dan Inovasi Aplikasi Basis Data.</p>
<p>Minta AI menjelaskan **Interoperabilitas, Open Data Riset, dan Inovasi Aplikasi Basis Data** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b8fcfa29cd5a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 16</span>
<h3>Generative dan Agentic AI untuk UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan</h3>
...
<!-- BEGIN AI-INLINE:92a31ef6fb0c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Narasi Kasus Pembuka</h4>
<p><strong>Konteks:</strong> Pertemuan 16: UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan.</p>
...
<!-- BEGIN AI-INLINE:c1fc2e59ff7f -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti</h4>
<p><strong>Konteks:</strong> Pertemuan 16: UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan.</p>
<p>Minta AI menjelaskan **UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:20ef4b208340 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Struktur Proyek yang Disarankan</h4>
<p><strong>Konteks:</strong> Pertemuan 16: UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:bb85ab48f672 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Template Laporan Proyek</h4>
<p><strong>Konteks:</strong> Pertemuan 16: UAS: Presentasi Proyek Akhir dan Rencana Pengembangan Lanjutan.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:dfc823cfca98 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Bank Contoh Soal dan Jawaban Ringkas</h3>
...
<!-- BEGIN AI-INLINE:428e24b80c94 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Deskripsi Kasus</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Bank Contoh Soal dan Jawaban Ringkas.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:bd199084ac96 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Contoh Query Laporan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Bank Contoh Soal dan Jawaban Ringkas.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
Materi **Basis data** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- Pipeline ETL/ELT, data warehouse/lakehouse, streaming, API, cloud, dan pengantar vector database untuk aplikasi AI.
- Data quality, metadata, lineage, provenance, versioning, access control, privacy, keamanan, dan audit log.
- Proyek membangun data product yang terdokumentasi dengan data dictionary/datasheet, uji kualitas otomatis, dan kontrol penggunaan data sensitif.
