...
<!-- BEGIN AI-INLINE:7377e35b83ca -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Identitas dan Peta Pembelajaran</h3>

**Arah RPS.** A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan Desain Eksperimen. |
...
<!-- BEGIN AI-INLINE:6ee5237e0301 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 1</span>
<h3>Generative dan Agentic AI untuk Pendahuluan Desain Eksperimen</h3>
...
<!-- BEGIN AI-INLINE:e1983aa7ef31 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 2</span>
<h3>Generative dan Agentic AI untuk Faktor Kuantitatif dan Kualitatif dalam Eksperimen Faktorial</h3>

**Arah RPS.** Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Eksperimen Faktorial: Faktor Kuantitatif dan Kualitatif; Eksperimen Faktorial 2k dan 3k. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:516c3c5d9723 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Faktor Kuantitatif dan Kualitatif dalam Eksperimen Faktorial.</p>
<p>Minta AI menjelaskan **Faktor Kuantitatif dan Kualitatif dalam Eksperimen Faktorial** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b4c5daa7401c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Contoh Kasus Terapan</h4>
<p><strong>Konteks:</strong> Pertemuan 2: Faktor Kuantitatif dan Kualitatif dalam Eksperimen Faktorial.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:8e0fd6679e66 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 3</span>
<h3>Generative dan Agentic AI untuk Eksperimen Faktorial 2^k</h3>

**Arah RPS.** Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Ekspektasi Kuadrat Tengah (EKT) pada Model Tetap, Acak, dan Campuran. |
...
<!-- BEGIN AI-INLINE:843aaaddd4c5 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Eksperimen Faktorial 2^k.</p>
<p>Minta AI menjelaskan **Eksperimen Faktorial 2^k** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b6d909fda4a8 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Contoh Kasus Terapan</h4>
<p><strong>Konteks:</strong> Pertemuan 3: Eksperimen Faktorial 2^k.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:ba59dc627c85 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 4</span>
<h3>Generative dan Agentic AI untuk Eksperimen Faktorial 3^k dan Ekspektasi Kuadrat Tengah</h3>

**Arah RPS.** A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Model Satterthwaite pada Desain Eksperimen. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:093b3fe624c0 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 4: Eksperimen Faktorial 3^k dan Ekspektasi Kuadrat Tengah.</p>
<p>Minta AI menjelaskan **Eksperimen Faktorial 3^k dan Ekspektasi Kuadrat Tengah** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:e0fda57bf357 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 5</span>
<h3>Generative dan Agentic AI untuk Pembauran pada Desain Faktorial 2^k dan 3^k</h3>

**Arah RPS.** Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Pembauran pada Desain Faktorial 2k dan 3k; Pembauran dalam replikasi. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:2e269b89a65b -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 5: Pembauran pada Desain Faktorial 2^k dan 3^k.</p>
<p>Minta AI menjelaskan **Pembauran pada Desain Faktorial 2^k dan 3^k** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:54d07f6f9123 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 6</span>
<h3>Generative dan Agentic AI untuk Desain Baur Parsial dan Tanpa Replikasi</h3>

**Arah RPS.** Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Desain baur parsial. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:e90c3cb4e615 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 6: Desain Baur Parsial dan Tanpa Replikasi.</p>
<p>Minta AI menjelaskan **Desain Baur Parsial dan Tanpa Replikasi** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b63d61266cb2 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 7</span>
<h3>Generative dan Agentic AI untuk Faktorial Fraksional 2^k dan 3^k</h3>

**Arah RPS.** A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK2 melalui fokus: Pembauran tanpa replikasi; Faktorial Fraksional untuk Eksperimen Faktorial 2k dan 3k. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:dfc035fc01da -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 7: Faktorial Fraksional 2^k dan 3^k.</p>
<p>Minta AI menjelaskan **Faktorial Fraksional 2^k dan 3^k** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0c092ea9f15d -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 8</span>
<h3>Generative dan Agentic AI untuk ANAVA pada Desain Fraksional dan UTS Proyek Pendahuluan</h3>
...
<!-- BEGIN AI-INLINE:a6eaa7fb1c46 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 8: ANAVA pada Desain Fraksional dan UTS Proyek Pendahuluan.</p>
<p>Minta AI menjelaskan **ANAVA pada Desain Fraksional dan UTS Proyek Pendahuluan** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:684cdf3f5307 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 9</span>
<h3>Generative dan Agentic AI untuk Model dan Asumsi Eksperimen Tersarang</h3>

**Arah RPS.** Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Analisis Varians (ANAVA) pada Desain Fraksional. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:bce16b3126e0 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 9: Model dan Asumsi Eksperimen Tersarang.</p>
<p>Minta AI menjelaskan **Model dan Asumsi Eksperimen Tersarang** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:0b23e5457ffc -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 10</span>
<h3>Generative dan Agentic AI untuk Analisis Varians pada Faktorial Tersarang</h3>

**Arah RPS.** Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Model dan Asumsi Eksperimen Tersarang. |
| Generative AI | Digunakan untuk membandingkan kandidat model, menuliskan alasan pemilihan, dan mengusulkan diagnostik. |
| Agentic AI | Dapat memasang kandidat model, menjalankan diagnostik, membandingkan metrik, dan menghentikan proses pada kegagalan asumsi atau konvergensi; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa spesifikasi model, data leakage, konvergensi, residual, kalibrasi, ketidakpastian, dan overfitting; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:c3195bf06168 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 10: Analisis Varians pada Faktorial Tersarang.</p>
<p>Minta AI menjelaskan **Analisis Varians pada Faktorial Tersarang** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:b3525083f050 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 11</span>
<h3>Generative dan Agentic AI untuk Pembatasan Pengacakan pada Desain Faktorial</h3>

**Arah RPS.** A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Analisis Varians pada Eksperimen Tersarang dan Faktorial Tersarang; Pembatasan dalam Pengacakan pada Desain Faktorial. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:f47169fbca74 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 11: Pembatasan Pengacakan pada Desain Faktorial.</p>
<p>Minta AI menjelaskan **Pembatasan Pengacakan pada Desain Faktorial** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:911aec44ba50 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 12</span>
<h3>Generative dan Agentic AI untuk Desain Split Plot</h3>

**Arah RPS.** Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK3 melalui fokus: Desain Split Plot. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:13a57f568f80 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 12: Desain Split Plot.</p>
<p>Minta AI menjelaskan **Desain Split Plot** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:191c34121ca5 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 13</span>
<h3>Generative dan Agentic AI untuk Analisis Kovarians dalam Desain Eksperimen</h3>

**Arah RPS.** Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Analisis Kovarians (ANCOVA) dalam Desain Eksperimen. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:916dbc702c2e -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 13: Analisis Kovarians dalam Desain Eksperimen.</p>
<p>Minta AI menjelaskan **Analisis Kovarians dalam Desain Eksperimen** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:daa331cfa202 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 14</span>
<h3>Generative dan Agentic AI untuk Response Surface Methodology Tahap Awal</h3>

**Arah RPS.** A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Metode Permukaan Respon (Response Surface Methodology); Optimasi Titik Faktor pada Permukaan Respon. |
| Generative AI | Digunakan untuk merumuskan alternatif penjelasan, contoh, dan hipotesis awal. |
| Agentic AI | Dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:f675185a2d80 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 14: Response Surface Methodology Tahap Awal.</p>
<p>Minta AI menjelaskan **Response Surface Methodology Tahap Awal** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:16407cd43aba -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 15</span>
<h3>Generative dan Agentic AI untuk Optimasi Titik Faktor pada Permukaan Respon</h3>

**Arah RPS.** Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK4 melalui fokus: Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen. |
| Generative AI | Digunakan untuk menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis. |
| Agentic AI | Dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia; agen wajib berhenti pada checkpoint dosen/mahasiswa. |
| Human checkpoint | Mahasiswa memeriksa kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan; keluaran AI tidak diterima sebagai bukti kebenaran. |
| Artefak wajib | prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia. |
...
<!-- BEGIN AI-INLINE:460ee778a6ee -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 15: Optimasi Titik Faktor pada Permukaan Respon.</p>
<p>Minta AI menjelaskan **Optimasi Titik Faktor pada Permukaan Respon** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:c7ea57b3cb7c -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Pertemuan 16</span>
<h3>Generative dan Agentic AI untuk Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen</h3>
...
<!-- BEGIN AI-INLINE:226b28ca021e -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Konsep Inti dan Posisi dalam Desain Eksperimen</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen.</p>
<p>Minta AI menjelaskan **Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:664d53eeaaaf -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Format Laporan UTS</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:df4be0811f3f -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Format Laporan UAS</h4>
<p><strong>Konteks:</strong> Pertemuan 16: Interpretasi, Kesimpulan, dan Komunikasi Hasil Eksperimen.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Audit akhir prompt, sumber, kode, hasil, ketidakpastian, keterbatasan, fairness/privasi, serta log agen bila digunakan. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
Materi **Desain Eksperimen** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- A/B testing, sequential experiment, adaptive design, bandit sebagai pengayaan, serta randomization inference.
- Heterogeneous treatment effect, causal forest, optimasi desain dengan komputasi, dan pengendalian multiplicity.
- Proyek eksperimen nyata atau simulasi yang memuat preregistration, power analysis, ethical safeguards, dan pelaporan reproducible.
