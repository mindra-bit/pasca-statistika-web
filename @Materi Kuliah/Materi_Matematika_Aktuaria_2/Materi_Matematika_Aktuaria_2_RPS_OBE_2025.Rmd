...
<!-- BEGIN AI-INLINE:2347f5ff5ae6 -->
<div class="ai-inline">
<span class="ai-inline__label">AI sebagai tutor kritis</span>
<h4>Penerapan pada Contoh Konseptual dan Interpretasi</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Minta AI menjelaskan **Matematika Aktuaria 2** melalui definisi, analogi, contoh, dan contoh tandingan. Mahasiswa kemudian membandingkan penjelasan itu dengan rujukan primer, menandai simplifikasi yang keliru, dan menulis kembali konsep dengan bahasanya sendiri. AI tidak boleh menjadi satu-satunya sumber konsep.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:f33e714cf763 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Pertemuan 4: Aplikasi Multiple Life pada Asuransi Pasangan dan Keluarga</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Pertemuan 4: Aplikasi Multiple Life pada Asuransi Pasangan dan Keluarga secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:a7bdcb7d8e7a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Pertemuan 8: UTS: Evaluasi Produk dan Presentasi Proyek Pendahuluan</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Pertemuan 8: UTS: Evaluasi Produk dan Presentasi Proyek Pendahuluan secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:c6b54e3d3476 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Pertemuan 12: Konstruksi dan Implementasi MD Table dengan R</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Agen dapat menguji kasus batas, simulasi numerik, dan konsistensi hasil pada beberapa parameter. Tetapkan checkpoint sebelum perubahan data, pemilihan model, dan penerbitan hasil. **Mahasiswa wajib memeriksa:** setiap langkah aljabar, syarat regularitas, satuan, kasus batas, dan makna parameter. Simpan prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:89091fc0619b -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Proyek 1: Analisis Multiple Life Functions</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Proyek 1: Analisis Multiple Life Functions secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:af1224c599af -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Proyek 2: Evaluasi Produk Asuransi dan Anuitas Dua Kehidupan</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Proyek 2: Evaluasi Produk Asuransi dan Anuitas Dua Kehidupan secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:769cbee0c280 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Proyek 3: Konstruksi Multiple Decrement Table</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Proyek 3: Konstruksi Multiple Decrement Table secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:2f2ec985d6b5 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Proyek 4: Inovasi Benefit Premium dan Benefit Reserve</h4>
<p><strong>Konteks:</strong> Matematika Aktuaria 2.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: AI mendukung proses belajar Matematika Aktuaria 2 Proyek 4: Inovasi Benefit Premium dan Benefit Reserve secara terkontrol. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:25f70f218e5f -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Integrasi AI pada Bab 1</span>
<h3>Generative dan Agentic AI untuk Template Fungsi R Tambahan</h3>

**Arah RPS.** Machine learning untuk reserving, fraud detection, severity-frequency modeling, dan portfolio segmentation.

| Komponen | Implementasi pada bab ini |
|---|---|
| Target pembelajaran | Mendukung CPMK1 melalui fokus: Pendahuluan Multiple Life Functions; Pengantar dan ruang lingkup multiple life functions; Notasi dan definisi joint life dan last survivor status. |
...
<!-- BEGIN AI-INLINE:1ece6144b952 -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan Tambahan 3: Pendalaman UTS: Evaluasi Produk dan Presentasi Proyek Pendahuluan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Template Fungsi R Tambahan.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Machine learning untuk reserving, fraud detection, severity-frequency modeling, dan portfolio segmentation. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:29e4e2d357dc -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan Tambahan 6: Pendalaman UTS: Evaluasi Produk dan Presentasi Proyek Pendahuluan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Template Fungsi R Tambahan.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Machine learning untuk reserving, fraud detection, severity-frequency modeling, dan portfolio segmentation. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:8958f2fb430a -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">AI untuk aplikasi dan komunikasi</span>
<h4>Penerapan pada Catatan Tambahan 9: Pendalaman UTS: Evaluasi Produk dan Presentasi Proyek Pendahuluan</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Template Fungsi R Tambahan.</p>
<p>Terapkan arahan RPS berikut pada kasus bab ini: Machine learning untuk reserving, fraud detection, severity-frequency modeling, dan portfolio segmentation. Generative AI dapat menghasilkan beberapa skenario pemangku kepentingan dan draf narasi yang kemudian diperiksa terhadap hasil analisis; Agentic AI dapat merakit tabel, grafik, pemeriksaan konsistensi, dan daftar klaim–bukti sebelum laporan disetujui manusia. Checkpoint manusia mencakup kesesuaian klaim dengan bukti, ketidakpastian, keterbatasan, fairness, dan dampak keputusan. Semua klaim harus ditautkan ke output, ketidakpastian, dan sumber yang dapat diperiksa.</p>
</div>
<!-- END AI-INLINE -->
...
<!-- BEGIN AI-INLINE:4ddf7d944afc -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Catatan Tambahan 38: Pendalaman Konstruksi dan Implementasi MD Table dengan R</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Template Fungsi R Tambahan.</p>
...
<!-- BEGIN AI-INLINE:286b9c52e37e -->
<div class="ai-inline ai-inline--agentic">
<span class="ai-inline__label">Agentic AI dengan checkpoint</span>
<h4>Penerapan pada Catatan Tambahan 41: Pendalaman Konstruksi dan Implementasi MD Table dengan R</h4>
<p><strong>Konteks:</strong> Pertemuan 1: Template Fungsi R Tambahan.</p>
<p>Agen dapat menjalankan rangkaian pemeriksaan data–model–diagnostik secara bertahap. Tetapkan checkpoint sebelum perubahan data, pemilihan model, dan penerbitan hasil. **Mahasiswa wajib memeriksa:** ketepatan konsep, asumsi metode, hasil numerik, dan interpretasi substantif. Simpan prompt log ringkas, keluaran awal, perubahan yang dilakukan mahasiswa, sumber pembanding, kode/notebook yang dapat dijalankan ulang, hasil validasi, dan keputusan akhir manusia.</p>
</div>
<!-- END AI-INLINE -->
...
Materi **Matematika Aktuaria 2** ini telah diselaraskan dengan RPS Revisi AI 2026. Rumusan CPL
...
- Machine learning untuk reserving, fraud detection, severity-frequency modeling, dan portfolio segmentation.
- Model risk, stress testing, explainability, monitoring drift, dan tata kelola penggunaan model dalam keputusan aktuaria.
- Proyek data nyata/sintetik yang menghasilkan model card, laporan validasi, dan rekomendasi keputusan yang mempertimbangkan fairness.
