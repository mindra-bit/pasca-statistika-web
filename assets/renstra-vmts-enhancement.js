(() => {
  ...
  const VERSION = "20260808-vmts-foundation-evaluation";
  ...
  const styles = `<style id="renstra-vmts-styles">
    ...
    @media(max-width:1080px){.vmts-report-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.vmts-foundation-report-card{grid-column:span 2}}
    ...
    @media(max-width:560px){.profile-strategic-card{grid-template-columns:44px minmax(0,1fr) 30px;padding:17px}.profile-strategic-icon{width:42px;height:42px}.profile-vmts-actions a,.renstra-vmts-bottom-actions a{flex:1 1 135px}.vmts-report-grid{grid-template-columns:1fr}.vmts-foundation-report-card{grid-column:span 1}.renstra-vmts-reports:before{clip-path:polygon(0 0,100% 0,100% 28%,0 42%)}.vmts-survey-action{width:100%;justify-content:center}}
  </style>`;
  ...
  const vmtsReportsCard = `<section class="renstra-vmts-reports" id="lampiran-sosialisasi-vmts" aria-labelledby="lampiran-sosialisasi-vmts-title">
    <div class="vmts-report-head">
      <div>
        ...
        <h3 id="lampiran-sosialisasi-vmts-title"><span class="vmts-lang-id">Dasar Evaluasi dan Sosialisasi VMTS S2 Statistika Terapan FMIPA UNPAD</span><span class="vmts-lang-en" lang="en">VMTS Evaluation Basis and Socialization Reports for the Applied Statistics Master's Program</span></h3>
        <p><span class="vmts-lang-id">Bagian ini memuat laporan evaluasi VMTS 2020-2022 sebagai salah satu dasar penyusunan VMTS 2023-2028, dilanjutkan dengan laporan sosialisasi VMTS kepada dosen, mahasiswa, dan pemangku kepentingan.</span><span class="vmts-lang-en" lang="en">This section includes the 2020-2022 VMTS evaluation report as one evidence base for developing the 2023-2028 VMTS, followed by VMTS socialization reports for lecturers, students, and stakeholders.</span></p>
      </div>
      <div class="vmts-report-count" aria-hidden="true"><strong>5</strong><span>HTML</span></div>
    </div>
